    ...
    <div class="container">
      ...
      <div class="contact-form">
        <form @submit.prevent="submit" enctype="multipart/form-data" >
          ...
          <input type="file" name="file" id="file" v-on:change="onChange" />
  ...
  methods: {
   ...
   this.file =e.target.files[0];
    ...
    submit() {
      ...
      fed.append("title",this.title);
      fed.append("file",this.file);
      fed.append("category_id",this.category_id);
      fed.append("body",this.body);
